...
public interface AppServerInterface {
  public static final org.apache.avro.Protocol PROTOCOL = org.apache.avro.Protocol.parse("{\"protocol\":\"AppServerInterface\",\"namespace\":\"server\",\"types\":[{\"type\":\"enum\",\"name\":\"ClientStatus\",\"symbols\":[\"LOBBY\",\"PUBLIC\",\"PRIVATE\"]}],\"messages\":{\"registerClient\":{\"request\":[{\"name\":\"username\",\"type\":\"string\"},{\"name\":\"ipaddress\",\"type\":\"string\"},{\"name\":\"port\",\"type\":\"int\"}],\"response\":\"int\"},\"isNameAvailable\":{\"request\":[{\"name\":\"username\",\"type\":\"string\"}],\"response\":\"boolean\"},\"exitClient\":{\"request\":[{\"name\":\"username\",\"type\":\"string\"}],\"response\":\"int\"},\"getListOfClients\":{\"request\":[],\"response\":\"string\"},\"setClientState\":{\"request\":[{\"name\":\"username\",\"type\":\"string\"},{\"name\":\"state\",\"type\":\"ClientStatus\"}],\"response\":\"int\"},\"sendMessage\":{\"request\":[{\"name\":\"username\",\"type\":\"string\"},{\"name\":\"message\",\"type\":\"string\"}],\"response\":\"int\"},\"sendRequest\":{\"request\":[{\"name\":\"username1\",\"type\":\"string\"},{\"name\":\"username2\",\"type\":\"string\"}],\"response\":\"int\"},\"requestResponse\":{\"request\":[{\"name\":\"username1\",\"type\":\"string\"},{\"name\":\"username2\",\"type\":\"string\"},{\"name\":\"responseBool\",\"type\":\"boolean\"}],\"response\":\"int\"},\"getMyRequests\":{\"request\":[{\"name\":\"username\",\"type\":\"string\"}],\"response\":\"string\"}}}");
