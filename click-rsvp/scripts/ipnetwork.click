...
AddressInfo(host1_address 192.168.10.1/24 tap0:eth)
AddressInfo(host2_address 192.168.11.1/24)
...
AddressInfo(router2_lan_address 192.168.11.254/24 eth0:eth);
...
host1 :: Host(host1_address, tap0, router1_lan_address);
...
FromDevice(eth0)
	...
	-> router2
	-> [1]network2
	-> router2lanlink :: BandwidthLimiter(1000kbps)
