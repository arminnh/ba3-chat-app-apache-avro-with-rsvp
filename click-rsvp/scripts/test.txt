#path messages
write rsvp.session DEST rsvp.2.3.4, PROTOCOL 1, POLICE true, PORT 50
...
write rsvp.scope SRC_ADDRESS 9.10.1rsvp.12
write rsvp.scope SRC_ADDRESS 13.14.15.16
write rsvp.timevalues REFRESH 6
write rsvp.resv TTL 246

write rsvp.session DEST 5.6.4.8, PROTOCOL 10, POLICE false, PORT 500
write rsvp.hop NEIGHBOR 2rsvp.13.14.51, LIH 51
write rsvp.timevalues REFRESH 6896
write rsvp.resvconfobj RECEIVER_ADDRESS 20.2rsvp.23.24
...
write rsvp.session DEST 5.6.4.8, PROTOCOL 10, POLICE false, PORT 500
write rsvp.errorspec ERROR_NODE_ADDRESS 1rsvp.12.13.14, INPLACE false, NOTGUILTY true, ERROR_CODE 123, ERROR_VALUE 789
...
write rsvp.session DEST 5.6.4.8, PROTOCOL 10, POLICE false, PORT 500
write rsvp.errorspec ERROR_NODE_ADDRESS 1rsvp.12.13.14, INPLACE false, NOTGUILTY true, ERROR_CODE 123, ERROR_VALUE 789
write rsvp.resvconfobj RECEIVER_ADDRESS 3rsvp.32.33.34
