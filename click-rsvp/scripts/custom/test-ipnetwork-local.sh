...
write host1/rsvp.senderdescriptor SRC_ADDRESS 192.168.10.1, SRC_PORT 2345, TOKEN_BUCKET_RATE 5.3, TOKEN_BUCKET_SIZE 50.77, PEAK_DATA_RATE 2.6, MINIMUM_POLICED_UNIT 5, MAXIMUM_PACKET_SIZE 5
write host1/rsvp.path REFRESH true

write host2/rsvp.session DEST 192.168.11.1, PROTOCOL 6, POLICE false, PORT 2345
write host2/rsvp.timevalues REFRESH 3
