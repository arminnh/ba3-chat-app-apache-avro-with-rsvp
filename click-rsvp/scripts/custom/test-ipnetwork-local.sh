...
write host1/rsvp.session DEST 192.168.11.1, PROTOCOL 0, POLICE false, PORT 2222
write host1/rsvp.hop NEIGHBOR 192.168.10.1, LIH 0
...
write host2/rsvp.hop NEIGHBOR 192.168.11.1, LIH 0
